...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "E:\\006_JavaProject\\newBeeMall\\src\\main\\resources\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public static final String MALL_USER_SESSION_KEY = "newBeeMallUser";//session中user的key
    ...
    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 10;//购物车中商品的最大数量(可根据自身需求修改)
