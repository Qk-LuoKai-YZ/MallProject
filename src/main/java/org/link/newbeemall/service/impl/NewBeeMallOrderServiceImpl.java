...
import org.link.newbeemall.common.*;
import org.link.newbeemall.controller.vo.*;
import org.link.newbeemall.dao.NewBeeMallGoodsMapper;
import org.link.newbeemall.dao.NewBeeMallOrderItemMapper;
import org.link.newbeemall.dao.NewBeeMallOrderMapper;
...
import org.link.newbeemall.util.NumberUtil;
 ...
 * FileName:NewBeeMallOrderServiceImpl
 * Author:  7ink
 * Data:    2024/5/16 8:19
 * Description:订单模块的实现代码
 * History:
...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
    ...
    @Override
    public Object getMyOrders(PageQueryUtil pageUtil) {
        int total = newBeeMallOrderMapper.getTotalNewBeeMallOrders(pageUtil);
        List<NewBeeMallOrder> newBeeMallOrders = newBeeMallOrderMapper.findNewBeeMallOrderList(pageUtil);
